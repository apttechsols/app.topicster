	...
	*/
	...
	if($DatabaseAccessCode == 'T@6Ug5t_u56t*P_B&B@Kl7U_v8N_xN7b_Z&B@Kl75t_u56@6Ug5t_u56t*P_B&Ap' || DatabaseAccessCode == 'T@6Ug5t_u56t*P_B&B@Kl7U_v8N_xN7b_Z&B@Kl75t_u56@6Ug5t_u56t*P_B&Ap'){
		...
		try {
			...
			$PdoTopicsterMain = new PDO("mysql:host=localhost;dbname=".DatabaseNamePrefix."topicster_main",'topicst1_Ap9919t','_L6sTh-FD2*hPpSjDeWSF5tMy-7D8ct:FfMSE@,-*VZ9EP_BvJSVe-4u*PhUJuWr');
			$PdoTopicsterMain->setAttribute(PDO::ATTR_DEFAULT_FETCH_MODE, PDO::FETCH_OBJ);
