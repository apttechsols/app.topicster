<?php
	...
	define('PageSetting', ['BrowserTitle'=>str_replace('>', ' &#187; ', Category).' : Category','PageTitle'=>str_replace('>', ' &#187; ', Category).' &#8594; Category']);
	...
	$GetArticle = AptPdoFetchWithAes(['Condtion'=> "Status::::Publish::,::Category::::||".str_replace('>', '||', Category)."||::::LikeValLike",'FetchData'=>'Url::::FUrl::::Title::::PublishTime::::MetaDescription::::Description::::Author::::ImageUrl', 'DbCon'=> $PdoTopicsterPostData, 'TbName'=> 'post', 'EPass'=> $EPass,'FetchRowNo'=>'All','Limit'=>5,'DataOrder'=>'DESC|PublishTime']);
		...
		<div style='margin-top: 25px;'>
			...
			foreach ($ArticleDtls as $key => $value) { ?>
				<div class="PostContent">
					<div><a href=<?php echo DomainName; ?>./Article/index.php?<?php echo $value['FUrl']; ?> name='<?php echo $value['Url']; ?>'><?php echo $value['Title']; ?></a></div>
					<div class="PostInfo">
