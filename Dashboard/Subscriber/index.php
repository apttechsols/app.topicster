<?php
	...
	if($IsLogin['code'] != 200 || $IsLogin['LAS'] != 'Subscriber'){
			...
			<div class="Main-Container">
				...
				<nav class="Header-Container">
					...
					<div class="TopRightIconBox">
						...
						<div>
							<?php if($IsLogin['msg']['Profile'] != ''){ ?>
							<img src="<?php echo RootPath.'Library/SiteComponents/AccountData/Profile/Subscriber/'.$IsLogin['msg']['Profile']; ?>" class="Image" style="cursor: pointer;"></div>
						<?php }else{ ?>
							<img src="<?php echo RootPath.'Library/ImageStore/GreenBoy-48px.png'; ?>" class="Image" style="cursor: pointer;"></div>
						<?php } ?>
					</div>
				</nav>
