<?php
    ...
    define('PageSetting', ['BrowserTitle'=>'Topicster : Edtior','PageTitle'=>'Article Edtior','css'=>['ArticleEdtior',RootPath.'Library/Apt/CSS/AptClassASelectBox/index.css'],'JavaScript'=>['ckeditor',RootPath.'Library/Apt/JavaScript/Jquery/AptClassASelectBox/index.js'],'HeaderMenuActive'=>'Account>Dashboard']);
    ...
    if($IsLogin['code'] != 200 || $IsLogin['LAS'] != 'Partner'){
        ...
        AptClassAFullScreenMsg(['msg'=>'Authentication failed [Login]']); exit();
    }
...
<div class="PredefineContainer">
    <div id='ArticleTitleBox'>
        ...
        <textarea type="text" name="ArticleTitle" class='ArticleTitle' id='ArticleTitle' maxlength='100' placeholder="Title of Article..."></textarea>
    </div>
    ...
    <div class='KeywordBox'>
        ...
        <span class='KeywordSubBox'>
            <input type='text' placeholder='Enter Keyword here' id='Keyword1' maxlength="20">
            <i class='fas fa-window-close ResetKeyword' name='Keyword1'></i>
        </span>
        <span class='KeywordSubBox'>
            <input type='text' placeholder='Enter Keyword here' id='Keyword2' maxlength="20">
            <i class='fas fa-window-close ResetKeyword' name='Keyword2'></i>
        </span>
        <span class='KeywordSubBox'>
            <input type='text' placeholder='Enter Keyword here' id='Keyword3' maxlength="20">
            <i class='fas fa-window-close ResetKeyword' name='Keyword3'></i>
        </span>
        <span class='KeywordSubBox'>
            <input type='text' placeholder='Enter Keyword here' id='Keyword4' maxlength="20">
            <i class='fas fa-window-close ResetKeyword' name='Keyword4'></i>
        </span>
        <span class='KeywordSubBox'>
            <input type='text' placeholder='Enter Keyword here' id='Keyword5' maxlength="20">
 ...
 <script>
    ...
    CKEDITOR.editorConfig = function( config ) {
        ...
        config.extraPlugins = 'AptBrowseImage,youtube,autogrow';
    ...
    $('.Submit').click(function(){
        ...
        imprint.test(browserTests).then(function(result){
            ...
            audioFingerprint.run(function (fingerprint_2) {
                ...
                formdata.append("EArticleTitle", encodeURI(ArticleTitle));
                formdata.append("EArticleDescription", encodeURI(ArticleDescription));
                formdata.append("Category", encodeURI(Category));
                formdata.append("SubCategory", encodeURI(SubCategory));
                formdata.append("Keyword1", encodeURI($('#Keyword1').val()));
                formdata.append("Keyword2", encodeURI($('#Keyword2').val()));
                formdata.append("Keyword3", encodeURI($('#Keyword3').val()));
                formdata.append("Keyword4", encodeURI($('#Keyword4').val()));
                formdata.append("Keyword5", encodeURI($('#Keyword5').val()));
                ...
                try{
                    ...
                    ajax.open("POST", RootPath+"Dashboard/Partner/WriteArticle/index.php");
                    ajax.send(formdata);
                }catch(error){
