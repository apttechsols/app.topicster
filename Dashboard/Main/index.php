			...
			<nav class="SideBar">
				<div class="SideBar-inner">
					<div class="Sidebar-side">
						...
						<?php if($IsLogin['msg']['Position'] == 'Owner'){ ?>
							<a class="Sidebar-Item" id='DMPartnerRequest' href='AccountReview/index.php'>
								<div class="desk">
									<div><i class="far fa-handshake IDMPartnerRequest"></i>Partner Request</div>
								</div>
							</a>
						<?php } ?>
						<a class="Sidebar-Item" id='SideBarNewArticleRequest' href='NewArticleRequest/index.php'>
							<div class="desk">
								<div><i class="far fa-newspaper ISideBarNewArticleRequest"></i>New Article Request</div>
							</div>
						</a>
					</div>
				</div>
			...
			<div class="Main-Container">
				...
				<nav class="Header-Container">
					...
					<div class="TopRightIconBox">
						...
						<div><img src="<?php echo MainDir.'ProfileImage/'.$IsLogin['msg']['Profile']; ?>" class="Image" style="cursor: pointer;"></div>
					</div>
				</nav>
